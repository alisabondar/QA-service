...
describe('Database Testing', () => {
  ...
  describe('API Testing', () => {
    ...
    productData = [{ "q_id": 31, "product_id": 4, "q_body": "Where is this product made?", "q_date": "2021-03-24T17:58:22.000Z", "q_name": "cleopatra", "q_email": "first.last@gmail.com", "q_report": 0, "q_helpful": 2 },
    { "q_id": 32, "product_id": 4, "q_body": "What fabric is the bottom made of?", "q_date": "2020-10-14T23:26:57.000Z", "q_name": "iluvcatz", "q_email": "first.last@gmail.com", "q_report": 0, "q_helpful": 7 },
    { "q_id": 33, "product_id": 4, "q_body": "Why is this product cheaper here than other sites?", "q_date": "2020-06-04T18:29:30.000Z", "q_name": "toofast", "q_email": "first.last@gmail.com", "q_report": 0, "q_helpful": 4 }];

    ansData = [{ "a_id": 679, "q_id": 350, "a_body": "Iusto non occaecati aut fuga.", "a_date": "2020-09-11T07:21:44.000Z", "a_name": "Stephen53", "a_email": "Aileen.Erdman@yahoo.com", "a_report": 0, "a_helpful": 14 },
    { "a_id": 680, "q_id": 350, "a_body": "Nulla voluptatem similique accusamus soluta.", "a_date": "2020-11-30T02:33:18.000Z", "a_name": "Josephine96", "a_email": "Skylar70@gmail.com", "a_report": 0, "a_helpful": 2 }]
    ...
    it('Should fetch correct questions based on product ID', () => {
      ...
      request(`http://${process.env.PGHOST}:${process.env.PGPORT}`)
        ...
        .expect(res => {
          ...
          expect(res.body[2].q_helpful).to.be.equal(productData[2].q_helpfulness);
        })
        .end((err) => {
          if (err) {
            throw err;
